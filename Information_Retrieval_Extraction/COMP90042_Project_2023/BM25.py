    ...
    def retrieve_docs(self, query, topk=1):
        ...
        for i, d in enumerate(docs):
            for w in query_words:
                scores[i] += self.TFIDF[(self.word2idx[w],d)]
...
class IR_System():
    ...
    def retrieve_docs(self, query, topk=1):
        ...
        # Calculate scores using advanced indexing
...
# @profile 
def eval(train_claims, val_claims, passage_ids, retreiver, k=10, num_claims=100):
    precision_tot = 0
    recall_tot = 0
    f1_tot = 0
    num_computed = 0
